...
<div align="center">
  ...
  [![Static Badge](https://img.shields.io/badge/Telegram-Bot%20Link-Link?style=for-the-badge&logo=Telegram&logoColor=white&logoSize=auto&color=blue)](https://t.me/catizenbot/bombie?startapp=g_1002_8150151)
...
<div align="center">
  ...
  > Поддердка разных операционных систем и кросс-компиляция!
  > Следите за обновлениями для получения полного функционала.
  
  [![Static Badge](https://img.shields.io/badge/📋_Исправления-ver_1.2.1-blue)](#-исправлено)
